      ...
      switch (state_)
      {
        case CALIBRATE_MEAN:
          ...
          else
          {
            ...
            image_pref.push_back(cv::IMWRITE_PNG_COMPRESSION);
        ...
        case LOAD_MEAN:
          mean_compensation_image_ = imread(package_path_ + "/config/mean_compensation.png", cv::IMREAD_GRAYSCALE);
        ...
        case LOAD_DEAD_PIXEL:
          inpaint_mask_ = imread(package_path_ + "/config/dead_pixel.png", cv::IMREAD_GRAYSCALE);
        ...
        case RUN:
          ...
          cv_bridge::CvImage* cv_ptr_colored =
              new cv_bridge::CvImage(header, sensor_msgs::image_encodings::BGR8, cvImage_colored);
